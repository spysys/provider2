package com.nexign.pipeeventsprovider.matcher;
 ...
 * of one or multiple {@link HashingAlgorithm
...
public abstract class TypedImageMatcher {
	...
	public static class AlgoSettings implements Serializable {
		...
		public boolean apply(Hash hash, Hash hash1) {
			if (normalized) {
//				System.out.println("Hash: " + hash.normalizedHammingDistanceFast(hash));
//				System.out.println("hash1: " + hash.normalizedHammingDistanceFast(hash1));
