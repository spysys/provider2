package com.nexign.pipeeventsprovider.benchmark;
...
import com.nexign.pipeeventsprovider.matcher.TypedImageMatcher;
	...
	protected void appendHashingDistances(StringBuilderI htmlBuilder, Map<HashingAlgorithm, Map<LabeledImage, Hash>> hashes,
		...
		for (LabeledImage base : imagesToTest) {
			...
			for (LabeledImage cross : sortedKeys) {
				htmlBuilder.append("<tr>");
				boolean first = true;
				for (Entry<HashingAlgorithm, TypedImageMatcher.AlgoSettings> entry : algorithmsToTest.entrySet()) {
