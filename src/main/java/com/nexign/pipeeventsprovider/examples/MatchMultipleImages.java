...
import com.nexign.pipeeventsprovider.matcher.cached.ConsecutiveMatcher;
...
public class MatchMultipleImages {
	...
	private void loadImages() {
		try {
			ballon = ImageIO.read(new FileInputStream("/Users/andrey.izzheurov/research/JImageHash/src/main/java/com/github/kilianB/examples/images/ballon.jpg"));
			copyright = ImageIO.read(new FileInputStream("/Users/andrey.izzheurov/research/JImageHash/src/main/java/com/github/kilianB/examples/images/copyright.jpg"));
			highQuality = ImageIO.read(new FileInputStream("/Users/andrey.izzheurov/research/JImageHash/src/main/java/com/github/kilianB/examples/images/highQuality.jpg"));
			lowQuality = ImageIO.read(new FileInputStream("/Users/andrey.izzheurov/research/JImageHash/src/main/java/com/github/kilianB/examples/images/lowQuality.jpg"));
			thumbnail = ImageIO.read(new FileInputStream("/Users/andrey.izzheurov/research/JImageHash/src/main/java/com/github/kilianB/examples/images/thumbnail.jpg"));
